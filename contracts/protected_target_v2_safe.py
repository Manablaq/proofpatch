...
class ProtectedTarget(gl.Contract):
    # EXACTLY the same persistent storage layout/order as v1.
    owner: Address
    ...
    # v2 adds a read-only feature without changing storage or privilege boundaries.
    @gl.public.view  # pyright: ignore[reportUnknownMemberType]
    def get_release_label(self) -> str:
        return "ProtectedTarget/v2-safe"
