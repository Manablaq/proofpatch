...
class ProtectedTarget(gl.Contract):
    ...
    def get_release_label(self) -> str:
        return "ProtectedTarget/v3-safe-assured"

    @gl.public.view  # pyright: ignore[reportUnknownMemberType]
    def get_runtime_canary(self) -> str:
        # Disposable fixture: source review can see the interface, while the
        # post-install canary records a state-dependent regression.
        return "FAIL_RUNTIME_CANARY"
