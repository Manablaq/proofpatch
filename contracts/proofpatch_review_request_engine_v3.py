...
class ProofPatchReviewRequestEngine(gl.Contract):
    ...
    def _incident(self, v, a, now):
        ...
        if i['status'] not in (STATUS_INCIDENT_OPEN,STATUS_INCIDENT_RETRY,STATUS_INCIDENT_REVIEW_PENDING): raise gl.vm.UserError('Incident is not reviewable')
